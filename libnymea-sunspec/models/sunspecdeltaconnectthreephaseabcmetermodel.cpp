...
SunSpecDeltaConnectThreePhaseAbcMeterModel::~SunSpecDeltaConnectThreePhaseAbcMeterModel()
{

}

QString SunSpecDeltaConnectThreePhaseAbcMeterModel::name() const
{
    return "ac_meter";
}

QString SunSpecDeltaConnectThreePhaseAbcMeterModel::description() const
{
    return QString();
}

QString SunSpecDeltaConnectThreePhaseAbcMeterModel::label() const
{
    return "delta-connect three phase (abc) meter";
}

float SunSpecDeltaConnectThreePhaseAbcMeterModel::amps() const
{
    return m_amps;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::ampsPhaseA() const
{
    return m_ampsPhaseA;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::ampsPhaseB() const
{
    return m_ampsPhaseB;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::ampsPhaseC() const
{
    return m_ampsPhaseC;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::voltageLn() const
{
    return m_voltageLn;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::phaseVoltageAn() const
{
    return m_phaseVoltageAn;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::phaseVoltageBn() const
{
    return m_phaseVoltageBn;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::phaseVoltageCn() const
{
    return m_phaseVoltageCn;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::voltageLl() const
{
    return m_voltageLl;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::phaseVoltageAb() const
{
    return m_phaseVoltageAb;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::phaseVoltageBc() const
{
    return m_phaseVoltageBc;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::phaseVoltageCa() const
{
    return m_phaseVoltageCa;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::hz() const
{
    return m_hz;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::watts() const
{
    return m_watts;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::wattsPhaseA() const
{
    return m_wattsPhaseA;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::wattsPhaseB() const
{
    return m_wattsPhaseB;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::wattsPhaseC() const
{
    return m_wattsPhaseC;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::va() const
{
    return m_va;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::vaPhaseA() const
{
    return m_vaPhaseA;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::vaPhaseB() const
{
    return m_vaPhaseB;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::vaPhaseC() const
{
    return m_vaPhaseC;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::var() const
{
    return m_var;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::varPhaseA() const
{
    return m_varPhaseA;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::varPhaseB() const
{
    return m_varPhaseB;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::varPhaseC() const
{
    return m_varPhaseC;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::pf() const
{
    return m_pf;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::pfPhaseA() const
{
    return m_pfPhaseA;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::pfPhaseB() const
{
    return m_pfPhaseB;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::pfPhaseC() const
{
    return m_pfPhaseC;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalWattHoursExported() const
{
    return m_totalWattHoursExported;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalWattHoursExportedPhaseA() const
{
    return m_totalWattHoursExportedPhaseA;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalWattHoursExportedPhaseB() const
{
    return m_totalWattHoursExportedPhaseB;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalWattHoursExportedPhaseC() const
{
    return m_totalWattHoursExportedPhaseC;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalWattHoursImported() const
{
    return m_totalWattHoursImported;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalWattHoursImportedPhaseA() const
{
    return m_totalWattHoursImportedPhaseA;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalWattHoursImportedPhaseB() const
{
    return m_totalWattHoursImportedPhaseB;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalWattHoursImportedPhaseC() const
{
    return m_totalWattHoursImportedPhaseC;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVaHoursExported() const
{
    return m_totalVaHoursExported;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVaHoursExportedPhaseA() const
{
    return m_totalVaHoursExportedPhaseA;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVaHoursExportedPhaseB() const
{
    return m_totalVaHoursExportedPhaseB;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVaHoursExportedPhaseC() const
{
    return m_totalVaHoursExportedPhaseC;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVaHoursImported() const
{
    return m_totalVaHoursImported;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVaHoursImportedPhaseA() const
{
    return m_totalVaHoursImportedPhaseA;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVaHoursImportedPhaseB() const
{
    return m_totalVaHoursImportedPhaseB;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVaHoursImportedPhaseC() const
{
    return m_totalVaHoursImportedPhaseC;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVarHoursImportedQ1() const
{
    return m_totalVarHoursImportedQ1;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVArHoursImportedQ1PhaseA() const
{
    return m_totalVArHoursImportedQ1PhaseA;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVArHoursImportedQ1PhaseB() const
{
    return m_totalVArHoursImportedQ1PhaseB;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVArHoursImportedQ1PhaseC() const
{
    return m_totalVArHoursImportedQ1PhaseC;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVArHoursImportedQ2() const
{
    return m_totalVArHoursImportedQ2;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVArHoursImportedQ2PhaseA() const
{
    return m_totalVArHoursImportedQ2PhaseA;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVArHoursImportedQ2PhaseB() const
{
    return m_totalVArHoursImportedQ2PhaseB;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVArHoursImportedQ2PhaseC() const
{
    return m_totalVArHoursImportedQ2PhaseC;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVArHoursExportedQ3() const
{
    return m_totalVArHoursExportedQ3;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVArHoursExportedQ3PhaseA() const
{
    return m_totalVArHoursExportedQ3PhaseA;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVArHoursExportedQ3PhaseB() const
{
    return m_totalVArHoursExportedQ3PhaseB;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVArHoursExportedQ3PhaseC() const
{
    return m_totalVArHoursExportedQ3PhaseC;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVArHoursExportedQ4() const
{
    return m_totalVArHoursExportedQ4;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVArHoursExportedQ4ImportedPhaseA() const
{
    return m_totalVArHoursExportedQ4ImportedPhaseA;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVArHoursExportedQ4ImportedPhaseB() const
{
    return m_totalVArHoursExportedQ4ImportedPhaseB;
}
float SunSpecDeltaConnectThreePhaseAbcMeterModel::totalVArHoursExportedQ4ImportedPhaseC() const
{
    return m_totalVArHoursExportedQ4ImportedPhaseC;
}
SunSpecDeltaConnectThreePhaseAbcMeterModel::EvtFlags SunSpecDeltaConnectThreePhaseAbcMeterModel::events() const
{
    return m_events;
}
void SunSpecDeltaConnectThreePhaseAbcMeterModel::initDataPoints()
{
...
void SunSpecDeltaConnectThreePhaseAbcMeterModel::processBlockData()
{
...
QDebug operator<<(QDebug debug, SunSpecDeltaConnectThreePhaseAbcMeterModel *model)
{
    debug.nospace().noquote() << "SunSpecDeltaConnectThreePhaseAbcMeterModel(Model: " << model->modelId() << ", Register: " << model->modbusStartRegister() << ", Length: " << model->modelLength() << ")" << endl;
