...
SunSpecInverterThreePhaseFloatModel::SunSpecInverterThreePhaseFloatModel(SunSpecConnection *connection, quint16 modbusStartRegister, quint16 length, QObject *parent) :
    SunSpecModel(connection, modbusStartRegister, 113, 60, parent)
{
    //Q_ASSERT_X(length == 60,  "SunSpecInverterThreePhaseFloatModel", QString("model length %1 given in the constructor does not match the model length from the specs %2.").arg(length).arg(modelLength()).toLatin1());
    Q_UNUSED(length)
    initDataPoints();
}

SunSpecInverterThreePhaseFloatModel::~SunSpecInverterThreePhaseFloatModel()
{

}

QString SunSpecInverterThreePhaseFloatModel::name() const
{
    return "inverter";
}

QString SunSpecInverterThreePhaseFloatModel::description() const
{
    return "Include this model for three phase inverter monitoring using float values";
}

QString SunSpecInverterThreePhaseFloatModel::label() const
{
    return "Inverter (Three Phase) FLOAT";
}

float SunSpecInverterThreePhaseFloatModel::amps() const
{
    return m_amps;
}
float SunSpecInverterThreePhaseFloatModel::ampsPhaseA() const
{
    return m_ampsPhaseA;
}
float SunSpecInverterThreePhaseFloatModel::ampsPhaseB() const
{
    return m_ampsPhaseB;
}
float SunSpecInverterThreePhaseFloatModel::ampsPhaseC() const
{
    return m_ampsPhaseC;
}
float SunSpecInverterThreePhaseFloatModel::phaseVoltageAb() const
{
    return m_phaseVoltageAb;
}
float SunSpecInverterThreePhaseFloatModel::phaseVoltageBc() const
{
    return m_phaseVoltageBc;
}
float SunSpecInverterThreePhaseFloatModel::phaseVoltageCa() const
{
    return m_phaseVoltageCa;
}
float SunSpecInverterThreePhaseFloatModel::phaseVoltageAn() const
{
    return m_phaseVoltageAn;
}
float SunSpecInverterThreePhaseFloatModel::phaseVoltageBn() const
{
    return m_phaseVoltageBn;
}
float SunSpecInverterThreePhaseFloatModel::phaseVoltageCn() const
{
    return m_phaseVoltageCn;
}
float SunSpecInverterThreePhaseFloatModel::watts() const
{
    return m_watts;
}
float SunSpecInverterThreePhaseFloatModel::hz() const
{
    return m_hz;
}
float SunSpecInverterThreePhaseFloatModel::va() const
{
    return m_va;
}
float SunSpecInverterThreePhaseFloatModel::vAr() const
{
    return m_vAr;
}
float SunSpecInverterThreePhaseFloatModel::pf() const
{
    return m_pf;
}
float SunSpecInverterThreePhaseFloatModel::wattHours() const
{
    return m_wattHours;
}
float SunSpecInverterThreePhaseFloatModel::dcAmps() const
{
    return m_dcAmps;
}
float SunSpecInverterThreePhaseFloatModel::dcVoltage() const
{
    return m_dcVoltage;
}
float SunSpecInverterThreePhaseFloatModel::dcWatts() const
{
    return m_dcWatts;
}
float SunSpecInverterThreePhaseFloatModel::cabinetTemperature() const
{
    return m_cabinetTemperature;
}
float SunSpecInverterThreePhaseFloatModel::heatSinkTemperature() const
{
    return m_heatSinkTemperature;
}
float SunSpecInverterThreePhaseFloatModel::transformerTemperature() const
{
    return m_transformerTemperature;
}
float SunSpecInverterThreePhaseFloatModel::otherTemperature() const
{
    return m_otherTemperature;
}
SunSpecInverterThreePhaseFloatModel::St SunSpecInverterThreePhaseFloatModel::operatingState() const
{
    return m_operatingState;
}
quint16 SunSpecInverterThreePhaseFloatModel::vendorOperatingState() const
{
    return m_vendorOperatingState;
}
SunSpecInverterThreePhaseFloatModel::Evt1Flags SunSpecInverterThreePhaseFloatModel::event1() const
{
    return m_event1;
}
quint32 SunSpecInverterThreePhaseFloatModel::eventBitfield2() const
{
    return m_eventBitfield2;
}
quint32 SunSpecInverterThreePhaseFloatModel::vendorEventBitfield1() const
{
    return m_vendorEventBitfield1;
}
quint32 SunSpecInverterThreePhaseFloatModel::vendorEventBitfield2() const
{
    return m_vendorEventBitfield2;
}
quint32 SunSpecInverterThreePhaseFloatModel::vendorEventBitfield3() const
{
    return m_vendorEventBitfield3;
}
quint32 SunSpecInverterThreePhaseFloatModel::vendorEventBitfield4() const
{
...
void SunSpecInverterThreePhaseFloatModel::initDataPoints()
{
...
QDebug operator<<(QDebug debug, SunSpecInverterThreePhaseFloatModel *model)
{
    debug.nospace().noquote() << "SunSpecInverterThreePhaseFloatModel(Model: " << model->modelId() << ", Register: " << model->modbusStartRegister() << ", Length: " << model->modelLength() << ")" << endl;
