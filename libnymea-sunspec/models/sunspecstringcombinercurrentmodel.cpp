...
void SunSpecStringCombinerCurrentModelRepeatingBlock::processBlockData()
{
...
SunSpecStringCombinerCurrentModel::SunSpecStringCombinerCurrentModel(SunSpecConnection *connection, quint16 modbusStartRegister, quint16 modelLength, SunSpecDataPoint::ByteOrder byteOrder, QObject *parent) :
    SunSpecModel(connection, modbusStartRegister, 403, modelLength, byteOrder, parent)
{
    m_modelBlockType = SunSpecModel::ModelBlockTypeFixedAndRepeating;

    initDataPoints();

    connect(this, &SunSpecModel::initFinished, this, &SunSpecStringCombinerCurrentModel::setupRepeatingBlocks);
}
...
void SunSpecStringCombinerCurrentModel::setupRepeatingBlocks()
{
    ...
    for (int i = 0; i < numberOfBlocks; ++i) {
        ...
        const auto block = new SunSpecStringCombinerCurrentModelRepeatingBlock(i, m_repeatingBlockLength, blockStartRegister, this);
