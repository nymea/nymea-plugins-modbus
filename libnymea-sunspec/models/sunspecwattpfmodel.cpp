...
void SunSpecWattPfModelRepeatingBlock::processBlockData()
{
    ...
    SunSpecModel(connection, modbusStartRegister, 131, modelLength, byteOrder, parent)
{
    ...
    connect(this, &SunSpecModel::initFinished, this, &SunSpecWattPfModel::setupRepeatingBlocks);
}
...
void SunSpecWattPfModel::setupRepeatingBlocks()
{
    ...
    for (int i = 0; i < numberOfBlocks; ++i) {
        ...
        const auto block = new SunSpecWattPfModelRepeatingBlock(i, m_repeatingBlockLength, blockStartRegister, this);
