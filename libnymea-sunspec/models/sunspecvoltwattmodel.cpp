...
void SunSpecVoltWattModelRepeatingBlock::processBlockData()
{
    ...
    SunSpecModel(connection, modbusStartRegister, 132, modelLength, byteOrder, parent)
{
    ...
    connect(this, &SunSpecModel::initFinished, this, &SunSpecVoltWattModel::setupRepeatingBlocks);
}
...
void SunSpecVoltWattModel::setupRepeatingBlocks()
{
    ...
    for (int i = 0; i < numberOfBlocks; ++i) {
        ...
        const auto block = new SunSpecVoltWattModelRepeatingBlock(i, m_repeatingBlockLength, blockStartRegister, this);
