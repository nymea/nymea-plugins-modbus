...
SunSpecHvrtxModel::SunSpecHvrtxModel(SunSpec *connection, quint16 modbusStartRegister, QObject *parent) :
    SunSpecModel(connection, 140, 10, modbusStartRegister, parent)
{
    initDataPoints();
}
