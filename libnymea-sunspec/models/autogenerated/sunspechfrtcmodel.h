...
class SunSpecHfrtcModel : public SunSpecModel
{
    Q_OBJECT
public:
    ...
    explicit SunSpecHfrtcModel(SunSpec *connection, quint16 modelId, quint16 modelLength, quint16 modbusStartRegister, QObject *parent = nullptr);
