...
SunSpecFlowBatteryModel::SunSpecFlowBatteryModel(SunSpec *connection, quint16 modbusStartRegister, QObject *parent) :
    SunSpecModel(connection, 806, 1, modbusStartRegister, parent)
{
    initDataPoints();
}
