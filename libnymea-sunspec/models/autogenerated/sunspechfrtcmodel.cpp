...
SunSpecHfrtcModel::SunSpecHfrtcModel(SunSpec *connection, quint16 modelId, quint16 modelLength, quint16 modbusStartRegister, QObject *parent) :
    SunSpecModel(connection, modelId, modelLength, modbusStartRegister, parent)
{
    initDataPoints();
    m_supportedModelIds << 142;
}
...
quint16 SunSpecHfrtcModel::modelId() const
{
    return m_modelId;
}
quint16 SunSpecHfrtcModel::modelLength() const
{
