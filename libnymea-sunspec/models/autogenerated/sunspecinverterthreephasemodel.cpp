...
SunSpecInverterThreePhaseModel::SunSpecInverterThreePhaseModel(SunSpec *connection, quint16 modbusStartRegister, QObject *parent) :
    SunSpecModel(connection, 103, 50, modbusStartRegister, parent)
{
    initDataPoints();
}
