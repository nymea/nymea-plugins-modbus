...
SunSpecLfrtModel::SunSpecLfrtModel(SunSpec *connection, quint16 modelId, quint16 modelLength, quint16 modbusStartRegister, QObject *parent) :
    SunSpecModel(connection, modelId, modelLength, modbusStartRegister, parent)
{
    initDataPoints();
    m_supportedModelIds << 135;
}
...
quint16 SunSpecLfrtModel::modelId() const
{
    return m_modelId;
}
quint16 SunSpecLfrtModel::modelLength() const
{
