...
#ifndef SUNSPECINVERTERTHREEPHASEFLOATMODEL_H
#define SUNSPECINVERTERTHREEPHASEFLOATMODEL_H
...
class SunSpecInverterThreePhaseFloatModel : public SunSpecModel
{
    Q_OBJECT
public:
    ...
    explicit SunSpecInverterThreePhaseFloatModel(SunSpec *connection, quint16 modbusStartRegister, QObject *parent = nullptr);
...
#endif // SUNSPECINVERTERTHREEPHASEFLOATMODEL_H
