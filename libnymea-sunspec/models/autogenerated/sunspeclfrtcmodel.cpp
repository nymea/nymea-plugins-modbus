...
SunSpecLfrtcModel::SunSpecLfrtcModel(SunSpec *connection, quint16 modelId, quint16 modelLength, quint16 modbusStartRegister, QObject *parent) :
    SunSpecModel(connection, modelId, modelLength, modbusStartRegister, parent)
{
    initDataPoints();
    m_supportedModelIds << 141;
}
...
quint16 SunSpecLfrtcModel::modelId() const
{
    return m_modelId;
}
quint16 SunSpecLfrtcModel::modelLength() const
{
