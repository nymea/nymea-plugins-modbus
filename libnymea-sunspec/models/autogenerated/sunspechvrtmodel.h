...
class SunSpecHvrtModel : public SunSpecModel
{
    Q_OBJECT
public:
    ...
    explicit SunSpecHvrtModel(SunSpec *connection, quint16 modelId, quint16 modelLength, quint16 modbusStartRegister, QObject *parent = nullptr);
