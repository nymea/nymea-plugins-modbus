...
public:
    ...
    explicit SunSpecFlowBatteryModuleModel(SunSpec *connection, quint16 modelId, quint16 modelLength, quint16 modbusStartRegister, QObject *parent = nullptr);
...
private:
    ...
    quint16 m_modulePointsToBeDetermined;
