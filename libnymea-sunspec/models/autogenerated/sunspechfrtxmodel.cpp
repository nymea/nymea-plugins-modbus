...
SunSpecHfrtxModel::SunSpecHfrtxModel(SunSpec *connection, quint16 modelId, quint16 modelLength, quint16 modbusStartRegister, QObject *parent) :
    SunSpecModel(connection, modelId, modelLength, modbusStartRegister, parent)
{
    initDataPoints();
    m_supportedModelIds << 144;
}
...
quint16 SunSpecHfrtxModel::modelId() const
{
    return m_modelId;
}
quint16 SunSpecHfrtxModel::modelLength() const
{
