...
SunSpecLvrtModel::SunSpecLvrtModel(SunSpec *connection, quint16 modbusStartRegister, QObject *parent) :
    SunSpecModel(connection, 129, 10, modbusStartRegister, parent)
{
    initDataPoints();
}
