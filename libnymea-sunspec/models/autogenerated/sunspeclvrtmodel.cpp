...
SunSpecLvrtModel::SunSpecLvrtModel(SunSpec *connection, quint16 modelId, quint16 modelLength, quint16 modbusStartRegister, QObject *parent) :
    SunSpecModel(connection, modelId, modelLength, modbusStartRegister, parent)
{
    initDataPoints();
    m_supportedModelIds << 129;
}
...
quint16 SunSpecLvrtModel::modelId() const
{
    return m_modelId;
}
quint16 SunSpecLvrtModel::modelLength() const
{
