...
SunSpecInverterSinglePhaseFloatModel::SunSpecInverterSinglePhaseFloatModel(SunSpec *connection, quint16 modbusStartRegister, QObject *parent) :
    SunSpecModel(connection, 111, 60, modbusStartRegister, parent)
{
    initDataPoints();
}
