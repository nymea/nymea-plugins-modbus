...
#ifndef SUNSPECMETERSINGLEPHASEFLOATMODEL_H
#define SUNSPECMETERSINGLEPHASEFLOATMODEL_H
...
class SunSpecMeterSinglePhaseFloatModel : public SunSpecModel
{
    Q_OBJECT
public:
    ...
    explicit SunSpecMeterSinglePhaseFloatModel(SunSpecConnection *connection, quint16 modbusStartRegister, quint16 length, QObject *parent = nullptr);
