...
SunSpecInverterSinglePhaseModel::~SunSpecInverterSinglePhaseModel()
{

}

QString SunSpecInverterSinglePhaseModel::name() const
{
    return "inverter";
}

QString SunSpecInverterSinglePhaseModel::description() const
{
    return "Include this model for single phase inverter monitoring";
}

QString SunSpecInverterSinglePhaseModel::label() const
{
    return "Inverter (Single Phase)";
}

float SunSpecInverterSinglePhaseModel::amps() const
{
    return m_amps;
}
float SunSpecInverterSinglePhaseModel::ampsPhaseA() const
{
    return m_ampsPhaseA;
}
float SunSpecInverterSinglePhaseModel::ampsPhaseB() const
{
    return m_ampsPhaseB;
}
float SunSpecInverterSinglePhaseModel::ampsPhaseC() const
{
    return m_ampsPhaseC;
}
qint16 SunSpecInverterSinglePhaseModel::a_SF() const
{
    return m_a_SF;
}
float SunSpecInverterSinglePhaseModel::phaseVoltageAb() const
{
    return m_phaseVoltageAb;
}
float SunSpecInverterSinglePhaseModel::phaseVoltageBc() const
{
    return m_phaseVoltageBc;
}
float SunSpecInverterSinglePhaseModel::phaseVoltageCa() const
{
    return m_phaseVoltageCa;
}
float SunSpecInverterSinglePhaseModel::phaseVoltageAn() const
{
    return m_phaseVoltageAn;
}
float SunSpecInverterSinglePhaseModel::phaseVoltageBn() const
{
    return m_phaseVoltageBn;
}
float SunSpecInverterSinglePhaseModel::phaseVoltageCn() const
{
    return m_phaseVoltageCn;
}
qint16 SunSpecInverterSinglePhaseModel::v_SF() const
{
    return m_v_SF;
}
float SunSpecInverterSinglePhaseModel::watts() const
{
    return m_watts;
}
qint16 SunSpecInverterSinglePhaseModel::w_SF() const
{
    return m_w_SF;
}
float SunSpecInverterSinglePhaseModel::hz() const
{
    return m_hz;
}
qint16 SunSpecInverterSinglePhaseModel::hz_SF() const
{
    return m_hz_SF;
}
float SunSpecInverterSinglePhaseModel::va() const
{
    return m_va;
}
qint16 SunSpecInverterSinglePhaseModel::vA_SF() const
{
    return m_vA_SF;
}
float SunSpecInverterSinglePhaseModel::vAr() const
{
    return m_vAr;
}
qint16 SunSpecInverterSinglePhaseModel::vAr_SF() const
{
    return m_vAr_SF;
}
float SunSpecInverterSinglePhaseModel::pf() const
{
    return m_pf;
}
qint16 SunSpecInverterSinglePhaseModel::pF_SF() const
{
    return m_pF_SF;
}
quint32 SunSpecInverterSinglePhaseModel::wattHours() const
{
    return m_wattHours;
}
qint16 SunSpecInverterSinglePhaseModel::wH_SF() const
{
    return m_wH_SF;
}
float SunSpecInverterSinglePhaseModel::dcAmps() const
{
    return m_dcAmps;
}
qint16 SunSpecInverterSinglePhaseModel::dCA_SF() const
{
    return m_dCA_SF;
}
float SunSpecInverterSinglePhaseModel::dcVoltage() const
{
    return m_dcVoltage;
}
qint16 SunSpecInverterSinglePhaseModel::dCV_SF() const
{
    return m_dCV_SF;
}
float SunSpecInverterSinglePhaseModel::dcWatts() const
{
    return m_dcWatts;
}
qint16 SunSpecInverterSinglePhaseModel::dCW_SF() const
{
    return m_dCW_SF;
}
float SunSpecInverterSinglePhaseModel::cabinetTemperature() const
{
    return m_cabinetTemperature;
}
float SunSpecInverterSinglePhaseModel::heatSinkTemperature() const
{
    return m_heatSinkTemperature;
}
float SunSpecInverterSinglePhaseModel::transformerTemperature() const
{
    return m_transformerTemperature;
}
float SunSpecInverterSinglePhaseModel::otherTemperature() const
{
    return m_otherTemperature;
}
qint16 SunSpecInverterSinglePhaseModel::tmp_SF() const
{
    return m_tmp_SF;
}
SunSpecInverterSinglePhaseModel::St SunSpecInverterSinglePhaseModel::operatingState() const
{
    return m_operatingState;
}
quint16 SunSpecInverterSinglePhaseModel::vendorOperatingState() const
{
    return m_vendorOperatingState;
}
SunSpecInverterSinglePhaseModel::Evt1Flags SunSpecInverterSinglePhaseModel::event1() const
{
    return m_event1;
}
quint32 SunSpecInverterSinglePhaseModel::eventBitfield2() const
{
    return m_eventBitfield2;
}
quint32 SunSpecInverterSinglePhaseModel::vendorEventBitfield1() const
{
    return m_vendorEventBitfield1;
}
quint32 SunSpecInverterSinglePhaseModel::vendorEventBitfield2() const
{
    return m_vendorEventBitfield2;
}
quint32 SunSpecInverterSinglePhaseModel::vendorEventBitfield3() const
{
    return m_vendorEventBitfield3;
}
quint32 SunSpecInverterSinglePhaseModel::vendorEventBitfield4() const
{
    return m_vendorEventBitfield4;
}
void SunSpecInverterSinglePhaseModel::initDataPoints()
{
...
void SunSpecInverterSinglePhaseModel::processBlockData()
{
    // Scale factors
...
{
    debug.nospace().noquote() << "SunSpecInverterSinglePhaseModel(Model: " << model->modelId() << ", Register: " << model->modbusStartRegister() << ", Length: " << model->modelLength() << ")" << endl;
