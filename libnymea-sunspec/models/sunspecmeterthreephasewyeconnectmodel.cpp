...
SunSpecMeterThreePhaseWyeConnectModel::~SunSpecMeterThreePhaseWyeConnectModel()
{

}

QString SunSpecMeterThreePhaseWyeConnectModel::name() const
{
    return "ac_meter";
}

QString SunSpecMeterThreePhaseWyeConnectModel::description() const
{
    return QString();
}

QString SunSpecMeterThreePhaseWyeConnectModel::label() const
{
    return " Meter three phase wye-connect";
}

float SunSpecMeterThreePhaseWyeConnectModel::amps() const
{
    return m_amps;
}
float SunSpecMeterThreePhaseWyeConnectModel::ampsPhaseA() const
{
    return m_ampsPhaseA;
}
float SunSpecMeterThreePhaseWyeConnectModel::ampsPhaseB() const
{
    return m_ampsPhaseB;
}
float SunSpecMeterThreePhaseWyeConnectModel::ampsPhaseC() const
{
    return m_ampsPhaseC;
}
float SunSpecMeterThreePhaseWyeConnectModel::voltageLn() const
{
    return m_voltageLn;
}
float SunSpecMeterThreePhaseWyeConnectModel::phaseVoltageAn() const
{
    return m_phaseVoltageAn;
}
float SunSpecMeterThreePhaseWyeConnectModel::phaseVoltageBn() const
{
    return m_phaseVoltageBn;
}
float SunSpecMeterThreePhaseWyeConnectModel::phaseVoltageCn() const
{
    return m_phaseVoltageCn;
}
float SunSpecMeterThreePhaseWyeConnectModel::voltageLl() const
{
    return m_voltageLl;
}
float SunSpecMeterThreePhaseWyeConnectModel::phaseVoltageAb() const
{
    return m_phaseVoltageAb;
}
float SunSpecMeterThreePhaseWyeConnectModel::phaseVoltageBc() const
{
    return m_phaseVoltageBc;
}
float SunSpecMeterThreePhaseWyeConnectModel::phaseVoltageCa() const
{
    return m_phaseVoltageCa;
}
float SunSpecMeterThreePhaseWyeConnectModel::hz() const
{
    return m_hz;
}
float SunSpecMeterThreePhaseWyeConnectModel::watts() const
{
    return m_watts;
}
float SunSpecMeterThreePhaseWyeConnectModel::wattsPhaseA() const
{
    return m_wattsPhaseA;
}
float SunSpecMeterThreePhaseWyeConnectModel::wattsPhaseB() const
{
    return m_wattsPhaseB;
}
float SunSpecMeterThreePhaseWyeConnectModel::wattsPhaseC() const
{
    return m_wattsPhaseC;
}
float SunSpecMeterThreePhaseWyeConnectModel::va() const
{
    return m_va;
}
float SunSpecMeterThreePhaseWyeConnectModel::vaPhaseA() const
{
    return m_vaPhaseA;
}
float SunSpecMeterThreePhaseWyeConnectModel::vaPhaseB() const
{
    return m_vaPhaseB;
}
float SunSpecMeterThreePhaseWyeConnectModel::vaPhaseC() const
{
    return m_vaPhaseC;
}
float SunSpecMeterThreePhaseWyeConnectModel::var() const
{
    return m_var;
}
float SunSpecMeterThreePhaseWyeConnectModel::varPhaseA() const
{
    return m_varPhaseA;
}
float SunSpecMeterThreePhaseWyeConnectModel::varPhaseB() const
{
    return m_varPhaseB;
}
float SunSpecMeterThreePhaseWyeConnectModel::varPhaseC() const
{
    return m_varPhaseC;
}
float SunSpecMeterThreePhaseWyeConnectModel::pf() const
{
    return m_pf;
}
float SunSpecMeterThreePhaseWyeConnectModel::pfPhaseA() const
{
    return m_pfPhaseA;
}
float SunSpecMeterThreePhaseWyeConnectModel::pfPhaseB() const
{
    return m_pfPhaseB;
}
float SunSpecMeterThreePhaseWyeConnectModel::pfPhaseC() const
{
    return m_pfPhaseC;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalWattHoursExported() const
{
    return m_totalWattHoursExported;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalWattHoursExportedPhaseA() const
{
    return m_totalWattHoursExportedPhaseA;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalWattHoursExportedPhaseB() const
{
    return m_totalWattHoursExportedPhaseB;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalWattHoursExportedPhaseC() const
{
    return m_totalWattHoursExportedPhaseC;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalWattHoursImported() const
{
    return m_totalWattHoursImported;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalWattHoursImportedPhaseA() const
{
    return m_totalWattHoursImportedPhaseA;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalWattHoursImportedPhaseB() const
{
    return m_totalWattHoursImportedPhaseB;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalWattHoursImportedPhaseC() const
{
    return m_totalWattHoursImportedPhaseC;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVaHoursExported() const
{
    return m_totalVaHoursExported;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVaHoursExportedPhaseA() const
{
    return m_totalVaHoursExportedPhaseA;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVaHoursExportedPhaseB() const
{
    return m_totalVaHoursExportedPhaseB;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVaHoursExportedPhaseC() const
{
    return m_totalVaHoursExportedPhaseC;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVaHoursImported() const
{
    return m_totalVaHoursImported;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVaHoursImportedPhaseA() const
{
    return m_totalVaHoursImportedPhaseA;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVaHoursImportedPhaseB() const
{
    return m_totalVaHoursImportedPhaseB;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVaHoursImportedPhaseC() const
{
    return m_totalVaHoursImportedPhaseC;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVarHoursImportedQ1() const
{
    return m_totalVarHoursImportedQ1;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVArHoursImportedQ1PhaseA() const
{
    return m_totalVArHoursImportedQ1PhaseA;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVArHoursImportedQ1PhaseB() const
{
    return m_totalVArHoursImportedQ1PhaseB;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVArHoursImportedQ1PhaseC() const
{
    return m_totalVArHoursImportedQ1PhaseC;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVArHoursImportedQ2() const
{
    return m_totalVArHoursImportedQ2;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVArHoursImportedQ2PhaseA() const
{
    return m_totalVArHoursImportedQ2PhaseA;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVArHoursImportedQ2PhaseB() const
{
    return m_totalVArHoursImportedQ2PhaseB;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVArHoursImportedQ2PhaseC() const
{
    return m_totalVArHoursImportedQ2PhaseC;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVArHoursExportedQ3() const
{
    return m_totalVArHoursExportedQ3;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVArHoursExportedQ3PhaseA() const
{
    return m_totalVArHoursExportedQ3PhaseA;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVArHoursExportedQ3PhaseB() const
{
    return m_totalVArHoursExportedQ3PhaseB;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVArHoursExportedQ3PhaseC() const
{
    return m_totalVArHoursExportedQ3PhaseC;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVArHoursExportedQ4() const
{
    return m_totalVArHoursExportedQ4;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVArHoursExportedQ4ImportedPhaseA() const
{
    return m_totalVArHoursExportedQ4ImportedPhaseA;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVArHoursExportedQ4ImportedPhaseB() const
{
    return m_totalVArHoursExportedQ4ImportedPhaseB;
}
float SunSpecMeterThreePhaseWyeConnectModel::totalVArHoursExportedQ4ImportedPhaseC() const
{
    return m_totalVArHoursExportedQ4ImportedPhaseC;
}
SunSpecMeterThreePhaseWyeConnectModel::EvtFlags SunSpecMeterThreePhaseWyeConnectModel::events() const
{
    return m_events;
}
...
void SunSpecMeterThreePhaseWyeConnectModel::processBlockData()
{
