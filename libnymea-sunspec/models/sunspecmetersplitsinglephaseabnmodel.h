...
#ifndef SUNSPECMETERSPLITSINGLEPHASEABNMODEL_H
#define SUNSPECMETERSPLITSINGLEPHASEABNMODEL_H
...
class SunSpecMeterSplitSinglePhaseAbnModel : public SunSpecModel
{
    Q_OBJECT
public:
    ...
    explicit SunSpecMeterSplitSinglePhaseAbnModel(SunSpecConnection *connection, quint16 modbusStartRegister, quint16 length, QObject *parent = nullptr);
