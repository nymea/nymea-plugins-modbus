    ...
    SunSpecModel(connection, modbusStartRegister, 404, modelLength, byteOrder, parent)
{
    ...
    connect(this, &SunSpecModel::initFinished, this, &SunSpecStringCombinerAdvancedModel::setupRepeatingBlocks);
}
...
void SunSpecStringCombinerAdvancedModel::setupRepeatingBlocks()
{
    ...
    for (int i = 0; i < numberOfBlocks; ++i) {
        ...
        const auto block = new SunSpecStringCombinerAdvancedModelRepeatingBlock(i, m_repeatingBlockLength, blockStartRegister, this);
