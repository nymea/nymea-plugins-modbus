    ...
    */
    ...
    connect(connection, &SungrowModbusTcpConnection::reachableChanged, this, [=](bool reachable){
        ...
        connect(connection, &SungrowModbusTcpConnection::initializationFinished, this, [=](bool success){
            ...
            qCInfo(dcSungrow()) << "    - Protocol number:" << connection->protocolNumber();
            qCInfo(dcSungrow()) << "    - Protocol version:" << connection->protocolVersion();
            qCInfo(dcSungrow()) << "    - ARM software version:" << connection->armSoftwareVersion();
            qCInfo(dcSungrow()) << "    - DSP software version:" << connection->dspSoftwareVersion();
